        ...
        <div class="container">
                ...
                <div class="price d-flex align-items-center mb-4">
                        ...
                        <div class="content d-flex flex-wrap">
                                <label for="" class="inline-block price_range px-4  rounded me-3">Trên 50 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">40 - 50 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">30 - 40 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">20 - 30 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">15 - 20 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">10 - 15 triệu </label>
                                <label for="" class="inline-block price_range px-4  rounded me-3">Dưới 10 triệu </label>
                        </div>
                </div>
